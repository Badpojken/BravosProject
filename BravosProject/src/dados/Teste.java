...
public class Teste {
	...
	public static void main(String[] args) {
		...
		Produto p1 = new Produto(10, "BigCheddar");
		 ...
		 * bomdia.criarProduto(new Produto(10, "bomdia")); bomdia.criarProduto(new
		 * Produto(5, "boanoite")); bomdia.salvarEmJson(); bomdia.copiandoDoJson();
		 * System.out.println(bomdia);
		 * 
		 * 
		 * Produto p = new Produto(10, "batata"); ProdutoQuantidade pQ = new
		 * ProdutoQuantidade(p , 1); ArrayList<ProdutoQuantidade> aPQ = new
		 * ArrayList<>(); aPQ.add(pQ);
		 * 
		 * pQ.calcPrecoParcial(); p.setEstoque(true); p.setDescricaoProduto("Teste");
		 * Cliente c = new Cliente("alsdasd", "ASDAS"); Pedido p1 = new Pedido(aPQ,c);
		 * RepositorioPedidos rP1 = new RepositorioPedidos(); rP1.addPedido(p1);
		 * p1.dataHorarioPedido(); p1.calcPrecoTotal(); rP1.salvarEmJson();
		 * rP1.copiandoDoJson(); System.out.println(rP1.toString());
		 * rP1.removePedido(p1); rP1.removerDoJson(); System.out.println(rP1); /*
		 * 
